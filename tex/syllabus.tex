%% NOTES FOR FUTURE HOGG:
%% ----------------------
%% - Make the grade cutoffs 85.0 and etc.0 to make it clear there will not be rounding!
%% - Add in the ISBN numbers for the textbooks; what's written here is ambiguous.
%% - Add in the REQUIREMENT of having the netIDs of at least three other students or "buddies".
%% - Change the exam schedule so that (roughly) there is an exam every 4 lectures. That almost works. Right now it is messed.
...
\afterpage{\fancyhead[R]{\fancyplain{}\sffamily{2021 Fall}}}
...
\textsl{office hours:} M 10:00-12:00 and Th 09:30--11:30 \textsl{at} 726 Broadway, room 1050
...
Your Lab Instructor is a physicist and teacher, who can help you.
...
\textbf{A missed Lab will be graded zero unless it is the result of a
  health condition or a religious observation}. You must notify
...
\textbf{Any missed Exam will be graded zero except where forced by a
  health condition or a religious observation}. If there is a
health condition that prevents attendance at a Term Exam,
or an announced-in-advance (to Prof Hogg) religious observance, it will
be pro-rated
...
Grades will be assigned in one-to-one correspondence with the
...
HOGG: THE PHASING OF THE EXAMS IS NOT QUITE RIGHT. FIX THAT FOR NEXT TIME!!
\begin{description}
...
\item[week of Oct~04:] Lectures: The photoelectric effect.
  ...
  \textbf{Term Exam 2} in Lecture on Thursday Oct~07.
